...
const SPECIAL_TYPES: [&'static str; 10] = ["StackStr", "StackFn", "StackTable", "StackUd", "StackValue", "LStr<Borrowed>", "Func<Borrowed", "Table<Borrowed>", "Ud<Borrowed", "Value<Borrowed>"];
